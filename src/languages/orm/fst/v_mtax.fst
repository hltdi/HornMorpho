...
# 3sf pres
sbj_t -> main     [i:]     [sb=[-p1,-p2,-pl,+fem],t=prs,-neg]
...
# 3sm, 3p
sbj_3 -> tam      [:]      [sb=[-fem,-pl]];[sb=[+pl],t=prs,-neg]
...
tam -> main       [a:]     [t=prs,-neg,sb=[+p1,-p2]];[t=prs,-neg,sb=[-p1,-p2,-fem,-pl]];[t=prs,-neg,sb=[-p1,+p2,-pl]]
