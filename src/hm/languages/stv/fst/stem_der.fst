...
1a.3 -> 1b.3       [aa]     [as=it];[as=smp]  # C verbs
1b.3 -> 1c.3       [M]
...
1a.3 -> 1b.3      [aa:]    [vc=ps,as=rc];[vc=tr,as=rc];[vc=cs,as=rc]
...
# ee, oo also possible with initial '
2bD.4 -> 2b.4     [aa:;aa;ee;oo]
# Recip
2a.4 -> 2b.4      [aa:]    [vc=ps,as=rc];[vc=tr,as=rc];[vc=cs,as=rc]
# Lexical long vowels (probably only possible with C1=')
2a.4 -> 2b.4      [aa;oo;ee] [as=smp]
