...
defplr -> case    <Poota:-oota> [+pl]
# Initial i- replaces any stem-final vowel
defplr -> def1    [D:]          [+def]
def1 -> case      <cha:-icha>   [-fem]
def1 -> case      <ttii:-ittii> [+fem]
defplr -> case    [:]           [-def,-pl]
...
case -> conj     <S:-ni>      [case=sb,-gen]
# Genitive, dative, instrumental, ablative
# Lengthen final vowel or add -ii to n
case -> caseL    <L:-L>     
caseL -> conj    [:]          [case=abl,-gen];[case=dat,-gen];[case=bs,+gen]
caseL -> conj    <f:-f>       [case=dat,-gen]
caseL -> conj    <n:-n>       [case=ins,-gen]
caseL -> conj    <tii:-tii>   [case=abl,+gen]
caseL -> conj    <tiin:-tiin> [case=ins,+gen]
# is this possible?
caseL -> conj    <tiif:-tiif> [case=dat,+gen]
...
dhaa -> conj    <f:-f>        [case=dat,-gen]
dhaa -> conj    <n:-n>        [case=ins,-gen]
## Locative
# doesn't require lengthened vowel
case -> conj     <tti:-tti>   [case=loc]
...
f -> 1s_sb       [:]              [+1s_sb]
f -> end        [i:;:]            [-1s_sb]
conj -> 1s_sb   <simmoo:-simmoo>  [cnj=simmoo]
conj -> 1s_sb   <oo:-oo>          [cnj=oo]
conj -> 1s_sb   <woo:-woo>        [cnj=woo]
conj -> 1s_sb   <llee:-llee>      [cnj=llee]
conj -> 1s_sb   <mmoo:-mmoo>      [cnj=mmoo]
conj -> 1s_sb   <moo:-moo>        [cnj=moo]
# -tu is not really a conjunction, but seems not to co-occur with any of them
conj -> 1s_sb   <tu:-tu>          [cnj=tu]
# No conjunction
conj -> 1s_sb   [:]               [cnj=None]
