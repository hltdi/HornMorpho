...
sbjs_i -> obj        <u:-u(@pron,subj,$number=plur,person=2/3)>   [sb=[-p1,+plr],ob=[+expl]];[sb=[-p1,+plr],ob=[-expl],ax=None]
#;[sb=[-p1,+plr],+def]
...
sbjs_pk -> obj        <e:(@pron,subj,$gender=masc,number=sing,person=2)-e->   [sb=[-p1,+p2,-fem],ob=[-prp,-p2,+expl]]
