...
objs1  -> negs_aux     <N_:-N_(@pron,objc,$number=sing,person=1,*ኝ,~obl)>  [ob=[+p1,-p2,-plr,+prp]]
objs1  -> negs_aux     <h:-h(@pron,objc,$gender=masc,number=sing,person=2,*ህ,~obl)>   [ob=[-p1,+p2,-plr,-fem,-frm,+prp]]
objs1  -> negs_aux     <x:-x(@pron,objc,$gender=fem,number=sing,person=2,*ሽ,~obl)>   [ob=[-p1,+p2,-plr,+fem,-frm,+prp]]
p# lemma could also be ው (generic 3sm object)
objs1  -> negs_aux    <et:-et(@pron,objc,$gender=masc,number=sing,person=3,*ኧት,~obl)>     [ob=[-p1,-p2,-plr,-fem,+prp]]
...
objs1  -> negs_aux    <at:-At(@pron,objc,$gender=fem,number=sing,person=3,*ኣት,~obl)>   [ob=[-p1,-p2,-plr,+fem,+prp]]
objs1  -> negs_aux     <n:-n(@pron,objc,$number=plur,person=1,*ን,~obl)>    [ob=[+p1,-p2,+plr,+prp]]
objs1  -> negs_aux   <ac_hu:-Ac_hu(@pron,objc,$number=plur,person=2,*ኣችሁ,~obl)> [ob=[-p1,+p2,+plr,-frm,+prp]]
objs1  -> negs_aux   <ac_ew:-Ac_ew(@pron,objc,$number=plur,person=3,*ኣቸው,~obl)> [ob=[-p1,-p2,+plr,+prp]]
objs1  -> objs_2frm    <wo:-wo(@pron,objc,$person=2,polite=form,*ዎ,~obl)>  [ob=[-p1,+p2,-plr,+frm,+prp]]
