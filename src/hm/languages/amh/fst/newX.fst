...
start -> end       <neN:{n++ne}($tense=pres,*ን) -N(@pron,subc,$number=sing,person=1,*ኝ,~nsubj)>    [tm=prs,pos=aux,-neg,-rel,-sub,sb=[+p1,-p2,-plr],ob=[-expl]]
start -> end        <neh:{n++ne}($tense=pres,*ን) -h(@pron,subc,$gender=masc,number=sing,person=2,*ህ,~nsubj)>   [tm=prs,pos=aux,-neg,-rel,-sub,sb=[-p1,+p2,-fem,-plr,-frm],ob=[-expl]]
start -> end        <nex:{n++ne}($tense=pres,*ን) -x(@pron,subc,$gender=fem,number=sing,person=2,*ሽ,~nsubj)>   [tm=prs,pos=aux,-neg,-rel,-sub,sb=[-p1,+p2,+fem,-plr,-frm],ob=[-expl]]
start -> end        <new:{n++ne}($tense=pres,*ን) -w(@pron,subc,$gender=masc,number=sing,person=3,*ው,~nsubj)>   [tm=prs,pos=aux,-neg,-rel,-sub,sb=[-p1,-p2,-fem,-plr],ob=[-expl]]
start -> end       <nec_:{n++ne}($tense=pres,*ን) -ec_(@pron,subc,$gender=fem,number=sing,person=3,*ኧች,~nsubj)>   [tm=prs,pos=aux,-neg,-rel,-sub,sb=[-p1,-p2,+fem,-plr],ob=[-expl]]
start -> end        <nat:{n++ne}($tense=pres,*ን) -at(@pron,subc,$gender=fem,number=sing,person=3,*ኧች,~nsubj)>   [tm=prs,pos=aux,-neg,-rel,-sub,sb=[-p1,-p2,+fem,-plr],ob=[-expl]]
start -> end        <nen:{n++ne}($tense=pres,*ን) -n(@pron,subc,$number=plur,person=1,*ን,~nsubj)>   [tm=prs,pos=aux,-neg,-rel,-sub,sb=[+p1,-p2,+plr],ob=[-expl]]
start -> end      <nac_hu:{n++ne}($tense=pres,*ን) -Ac_hu(@pron,subc,$number=plur,person=2,*ኣችሁ,~nsubj)>   [tm=prs,pos=aux,-neg,-rel,-sub,sb=[-p1,+p2,+plr,-frm],ob=[-expl]]
start -> end      <nac_ew:{n++ne}($tense=pres,*ን) -Ac_ew(@pron,subc,$number=plur,person=3,*ኣቸው,~nsubj)>   [tm=prs,pos=aux,-neg,-rel,-sub,sb=[-p1,-p2,+plr],ob=[-expl]]
start -> end       <newot:{n++ne}($tense=pres,*ን) -wot(@pron,subc,$person=2,polite=form,*ዎት,~nsubj)>   [tm=prs,pos=aux,-neg,-rel,-sub,sb=[-p1,+p2,-fem,-plr,+frm],ob=[-expl]]
