...
stem -> poss      +ppron+       [v=None,poss=[-expl],-dis,+def,-itu,-prp]
...
stem -> plr_oc     >>vnoun<<   [-p1,-p2,-prp,pos=n_dv]
stem -> plr_oc   +irr_vnoun+   [-p1,-p2,-prp,pos=n_dv]
...
poss -> acc       [:]      [poss=[-expl],-def,-prp,-itu];[poss=[-expl],+def,+prp,-itu];[poss=[-expl],+def,pos=pron,-itu]
...
poss -> acc       [u:]     [+def,poss=[-p1,-p2,-plr,-fem,+expl],-itu];[-plr,+det,+def,-fem,-prp,poss=[-expl],-itu];[+plr,+det,+def,-prp,poss=[-expl],-itu]
