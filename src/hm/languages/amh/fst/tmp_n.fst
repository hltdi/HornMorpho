### Generate template for segmentaton
...
bound -> pre    <:me>     [tmp=[pre=me]]
bound -> pre    <:ma>     [tmp=[pre=ma]]
bound -> pre    <:mas>    [tmp=[pre=mas]]
bound -> pre    <:mett>    [tmp=[pre=met]]
bound -> pre   <:mast>    [tmp=[pre=maste,c1=None,v1=a]]
bound -> pre   <:maste>    [tmp=[pre=maste,c1=None,v1=None]]
bound -> pre   <:teste>    [tmp=[pre=teste,c1=None,v1=None]]
bound -> pre   <:meste>    [tmp=[pre=meste,c1=None,v1=None]]

pre -> c1       [:]       [tmp=[c1=None]]
pre -> c1_      [:2]      [tmp=[c1=2]]
pre -> c1_      [:1]      [tmp=[c1=1]]

c1_ -> c1       [:]       [tmp=[-c1gem]];[tmp=[+c1gem,v1=Wa]]
c1_ -> c1       [:_]      [tmp=[+c1gem,v1=None]];[tmp=[+c1gem,v1=e]];[tmp=[+c1gem,v1=a]];[tmp=[+c1gem,v1=i]]

c1 -> v1        [:]       [tmp=[v1=None]]
c1 -> v1        [:e]      [tmp=[v1=e]]
c1 -> v1        [:a]      [tmp=[v1=a]]
c1 -> v1        [:i]      [tmp=[v1=i]]
c1 -> v1        <:Wa>     [tmp=[v1=Wa,-c1gem]]
c1 -> v1        <:W_a>    [tmp=[v1=Wa,+c1gem]]
...
v4 -> c_2_      [:]       [tmp=[c_2=None,c2=None]]
v4 -> c_2_      [:1]      [tmp=[c_2=1]]
v4 -> c_2       [:2]      [tmp=[c_2=2]]
v4 -> c_2       [:]       [tmp=[c2=2,c3=None,c4=None,c_2=None]]
v4 -> c_2       [:3]      [tmp=[c_2=3]]
v4 -> c_2       [:4]      [tmp=[c_2=4]]
...
c_1 -> suff     [:]       [tmp=[suff=None]]
c_1 -> suff     [:i]      [tmp=[suff=i]]
c_1 -> suff     <:iya>    [tmp=[suff=iya]]
