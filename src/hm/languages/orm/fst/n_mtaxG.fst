### Oromo noun and adjective morphotactics for generation
### Features
...
case -> caseL    [L:]
# For generation, only genitive or ablative (not dative)
caseL -> conj    [:]      [case=abl,-gen];[case=bs,+gen]
...
case -> dhaa    [H:]
# For generation, ablative (not dative or instrumental)
dhaa -> conj    [:]       [case=abl,-gen]
