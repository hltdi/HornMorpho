...
# 1=L
start -> 1X		[ሀ;ህ;ሃ]			[tmp=[1=L],1=L,r1=ህ]
start -> 1X		[አ;እ;ኣ]			[tmp=[1=L],1=L,r1=እ]
start -> 1X		[ዐ;ዕ;ዓ]			[tmp=[1=L],1=L,r1=ዕ]
start -> 1X		[ሐ;ሕ;ሓ]		[tmp=[1=L],1=L,r1=ሕ]
...
start -> 2X		[ሌ;ሊ;ል]		[tmp=[1=X,2=ይ],2=ይ,-dup23,-gem2,a=0|a,r1=ል,r2=ይ]

# 2=ው
start -> 2X		[*o;*u;*]		[tmp=[1=X,2=ው],2=ው,-dup23,-gem2,a=0|a,r2=ው]
start -> 2X		[ሎ;ሉ;ል]			[tmp=[1=X,2=ው],2=ው,-dup23,-gem2,a=0|a,r1=ል,r2=ው]

1X -> 1X/		[/]				[+gem2]

1X -> 2X		[^^y]			[tmp=[2=ይ],2=ይ,-gem2,a=0|a,r2=ይ]
1X -> 2X		[^^w]			[tmp=[2=ው],2=ው,-gem2,a=0|a,r2=ው]
