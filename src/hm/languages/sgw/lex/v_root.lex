...
nqyf   [root=[cls=A],am=hqf]
nqrrT  [root=[cls=F],am=kmcyF]
hrq    [root=[cls=A],am=tfhA]
hrb    [root=[cls=A],am=hlbA]
nbrrq  [root=[cls=F],am=brqrqG]
hd.g   [root=[cls=A],am=ThlA]
hg.d   [root=[cls=A],am=hsrA]
hkk    [root=[cls=A],dup=1,am=hkkA]
hmh    [root=[cls=A],am=hmhA]
