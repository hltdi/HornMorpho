## Chaha root -> derivational stems for jussive-imperative
## Features:
...
# initial w
A.cvcv -> pre_n   [w]    [root=[+tr]];[root=[-tr],sp=2]
A.cvcv -> pre_n   [:w]   [root=[-tr],sp=1|3]
...
voice -> end        [t:]   [vc=[+ps,-cs],sp=1|3]
voice -> end        <et:>  [vc=[+ps,-cs],sp=2]
