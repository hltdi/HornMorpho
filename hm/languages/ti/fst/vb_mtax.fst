### Basic morphotactics of Tigrinya verb
...
rel -> neg     [R:]     [+rel,tm=prf];[+rel,tm=imf];[+rel,tm=ger];[+rel,tm=prs]
rel -> neg     [:]      [-rel]
...
cj2 -> end     >>cnj2<<
# d- could be a prefix with tm=prs (dello): +yn
cj2 -> end  [:]           [cj2=None,-yn,-d,pos=v];[cj2=None,+yn,+d,pos=v]
