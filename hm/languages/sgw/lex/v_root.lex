...
shr  [root=[-tr,cls=A],tm=prf,am=ደስ_አለ,dup=None];[root=[-tr,cls=A],tm=j_i,am=ደስ_አለ,dup=None];[root=[-tr,cls=A],tm=inf,am=ደስ_አለ,dup=None]
...
dgr   [root=[cls=B],dup=None,am=ቸገረ]
